...
const metrics = [
    ...
    { icon: Flame, label: "Calories", value: "2,200" },
    { icon: Heart, label: "Heart Rate", value: "75 bpm" },
    { icon: Clock, label: "Workout Duration", value: "30 mins" },
    { icon: Moon, label: "Sleep", value: "7 hrs" },
    { icon: Apple, label: "Calorie Intake", value: "2,000 cals" },
]

export default function Dashboard() {
    return (
        <div className="max-w-7xl mx-auto">
            <h2 className="text-2xl font-semibold text-gray-900 mb-6">Good Morning, User!</h2>
